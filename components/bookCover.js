...
<article class="book-cover-c">
	...
	<img src="./public/img/magic/Role.jpg" class="star-out"/>
	<div>
</article>
`
bookCover.init = ({imgSrc, stellarRatio = 2, story, selector, alt = 'picture made with ink', flip = false}) => {
	$(selector).html(bookCover.html)
	if (flip) $(selector + ' article').addClass('flipped')
	const sectionElmt = $(selector + ' article>div>section')
	const imgElmt = $(selector + ' article>div>img')
	...
	}).get(0).dataset.stellarRatio = stellarRatio
